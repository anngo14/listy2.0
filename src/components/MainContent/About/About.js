    ...
    return (
        <div>
            ...
            <div id='about-content'>
                ...
                <p>
                    Most web applications with simple functionality are not going to be visited often or for long periods of time. Taking this into account I wanted to provide the user a really quick glimpses of information that would be useful. For example, the header on the Home page was meant to grab the user's attention quickly to tell the user what general time of day it is by using a duller color for other elements on the page. I'm terrible at drawing so the vision of the header never truly came into fruition, however this was the idea behind the header component on the Home page. 
                </p>
            </div>
        </div>
    )
